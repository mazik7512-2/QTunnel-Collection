...
namespace QVPN
{
	...
	namespace details
	{
		...
		using QVPNServerDriver = QVPN::Core::QVPNServerDriver<QVPN::Core::BaseTypes::UByte*, QVPN::Core::NetAddr, QVPNNetTools, Database, Stats, QVPNLogger, QVPN::Core::QVPNServerWorkMode::SERVER_VPN>;
	}
