...
void QVPN::Core::DataStructures::Ipv4PacketLittleEndian::set_data(UByte* begin, UByte* end)
{
	header_.clear();
	parse_packet(begin, end);
}
...
{
	return std::make_pair<>(header_.data() + default_ip_bytes, header_.data() + header_.size());
}
...
{
	return std::make_pair<>(header_.data(), header_.data() + header_.size());
}
...
QVPN::Core::DataStructures::Ipv4PacketLittleEndian::ObjectType QVPN::Core::DataStructures::Ipv4PacketLittleEndian::to_object()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ObjectType(start, end);
}

QVPN::Core::DataStructures::Ipv4PacketLittleEndian::ViewType QVPN::Core::DataStructures::Ipv4PacketLittleEndian::to_view()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
...
QVPN::Core::DataStructures::Ipv4PacketLittleEndian::ObjectType QVPN::Core::DataStructures::Ipv4PacketLittleEndian::to_net_object()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::Ipv4PacketLittleEndian::ViewType QVPN::Core::DataStructures::Ipv4PacketLittleEndian::to_net_view()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ViewType(start, end);
...
void QVPN::Core::DataStructures::Ipv4PacketLittleEndian::set_ip_total_length(UShort length)
{
	header_[2] = length >> 8 & 0xFF;
...
std::pair<QVPN::Core::DataStructures::Ipv4PacketLittleEndian::ConstDataIterator_t, QVPN::Core::DataStructures::Ipv4PacketLittleEndian::ConstDataIterator_t> QVPN::Core::DataStructures::Ipv4PacketLittleEndian::to_net_bytes() const
{
	return std::make_pair<>(header_.data(), header_.data() + header_.size());
}

std::pair<QVPN::Core::DataStructures::Ipv4PacketLittleEndian::DataIterator_t, QVPN::Core::DataStructures::Ipv4PacketLittleEndian::DataIterator_t> QVPN::Core::DataStructures::Ipv4PacketLittleEndian::to_net_bytes()
{
	return std::make_pair<>(header_.data(), header_.data() + header_.size());
}
...
{
	return std::make_pair<>(header_.data() + default_tcp_size, header_.data() + header_.size());
}
...
{
	return std::make_pair<ConstDataIterator_t, ConstDataIterator_t>(header_.data(), header_.data() + header_.size());
}
...
{
	return std::make_pair<DataIterator_t, DataIterator_t>(header_.data(), header_.data() + header_.size());
}

QVPN::Core::DataStructures::TcpPacketLittleEndian::ObjectType QVPN::Core::DataStructures::TcpPacketLittleEndian::to_object()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::TcpPacketLittleEndian::ViewType QVPN::Core::DataStructures::TcpPacketLittleEndian::to_view()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ViewType(start, end);
...
{
	return to_tcp_friendly_view();
}

QVPN::Core::DataStructures::TcpPacketLittleEndian::ObjectType QVPN::Core::DataStructures::TcpPacketLittleEndian::to_transport_object()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::TcpPacketLittleEndian::ViewType QVPN::Core::DataStructures::TcpPacketLittleEndian::to_transport_view()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ViewType(start, end);
...
std::vector<UByte> QVPN::Core::DataStructures::TcpPacketLittleEndian::generate_object_bytes(UShort src_port, UShort dst_port, UInt seq, UInt ack, UByte offset, TcpFlagsObject flags, UShort window_size, UShort urgent, UByte* opt_b, UByte* opt_e)
{
	...
	std::copy(opt_b, opt_e, std::back_inserter(bytes));
...
bool QVPN::Core::DataStructures::TcpPacketLittleEndian::is_reset_connection_packet() const
{
	auto flags = get_tcp_flags();
	if (flags.get_fin() == 1 || flags.get_rst() == 1)
		return true;
	return false;
}

std::pair<QVPN::Core::DataStructures::TcpPacketLittleEndian::ConstDataIterator_t, QVPN::Core::DataStructures::TcpPacketLittleEndian::ConstDataIterator_t> QVPN::Core::DataStructures::TcpPacketLittleEndian::to_transport_bytes() const
{
	return std::make_pair<ConstDataIterator_t, ConstDataIterator_t>(header_.data(), header_.data() + header_.size());
}

std::pair<QVPN::Core::DataStructures::TcpPacketLittleEndian::DataIterator_t, QVPN::Core::DataStructures::TcpPacketLittleEndian::DataIterator_t> QVPN::Core::DataStructures::TcpPacketLittleEndian::to_transport_bytes()
{
	return std::make_pair<DataIterator_t, DataIterator_t>(header_.data(), header_.data() + header_.size());
}
...
void QVPN::Core::DataStructures::TcpPacketLittleEndian::set_src_port(UShort port)
{
	header_[0] = static_cast<UByte>(port >> 8 & 0xFF);
	header_[1] = static_cast<UByte>(port & 0xFF);
}

void QVPN::Core::DataStructures::TcpPacketLittleEndian::set_transport_length(UShort bytes_length)
{
	UByte length = bytes_length / bytes_in_quartet;
...
void QVPN::Core::DataStructures::TcpPacketLittleEndian::set_tcp_length(UByte word_length)
{
...
QVPN::Core::DataStructures::UdpPacketLittleEndian::ObjectType QVPN::Core::DataStructures::UdpPacketLittleEndian::to_object()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::UdpPacketLittleEndian::ViewType QVPN::Core::DataStructures::UdpPacketLittleEndian::to_view()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ViewType(start, end);
...
QVPN::Core::DataStructures::UdpPacketLittleEndian::ObjectType QVPN::Core::DataStructures::UdpPacketLittleEndian::to_transport_object()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::UdpPacketLittleEndian::ViewType QVPN::Core::DataStructures::UdpPacketLittleEndian::to_transport_view()
{
	UByte* start = header_.data();
	UByte* end = header_.data() + header_.size();
	return ViewType(start, end);
...
bool QVPN::Core::DataStructures::UdpPacketLittleEndian::is_reset_connection_packet() const
{
	return false;
}

std::pair<QVPN::Core::DataStructures::UdpPacketLittleEndian::ConstDataIterator_t, QVPN::Core::DataStructures::UdpPacketLittleEndian::ConstDataIterator_t> QVPN::Core::DataStructures::UdpPacketLittleEndian::to_transport_bytes() const
{
	return std::make_pair<>(header_.data(), header_.data() + header_.size());
}

std::pair<QVPN::Core::DataStructures::UdpPacketLittleEndian::DataIterator_t, QVPN::Core::DataStructures::UdpPacketLittleEndian::DataIterator_t> QVPN::Core::DataStructures::UdpPacketLittleEndian::to_transport_bytes()
{
	return std::make_pair<>(header_.data(), header_.data() + header_.size());
}
...
void QVPN::Core::DataStructures::UdpPacketLittleEndian::set_src_port(UShort port)
{
	header_[0] = static_cast<UByte>(port >> 8 & 0xFF);
	header_[1] = static_cast<UByte>(port & 0xFF);
}
...
QVPN::Core::DataStructures::DataPacketLittleEndian::DataPacketLittleEndian()
	: data_{} {}
...
std::pair<QVPN::Core::DataStructures::DataPacketLittleEndian::ConstDataIterator_t, QVPN::Core::DataStructures::DataPacketLittleEndian::ConstDataIterator_t> QVPN::Core::DataStructures::DataPacketLittleEndian::get_payload() const
{
...
std::pair<QVPN::Core::DataStructures::DataPacketLittleEndian::ConstDataIterator_t, QVPN::Core::DataStructures::DataPacketLittleEndian::ConstDataIterator_t> QVPN::Core::DataStructures::DataPacketLittleEndian::to_data_bytes() const
{
	return std::make_pair<>(data_.data(), data_.data() + data_.size());
}

std::pair<QVPN::Core::DataStructures::DataPacketLittleEndian::DataIterator_t, QVPN::Core::DataStructures::DataPacketLittleEndian::DataIterator_t> QVPN::Core::DataStructures::DataPacketLittleEndian::to_data_bytes()
{
	return std::pair<DataIterator_t, DataIterator_t>(data_.data(), data_.data() + data_.size());
}
...
QVPN::Core::DataStructures::DataPacketLittleEndian::ObjectType QVPN::Core::DataStructures::DataPacketLittleEndian::to_object()
{
	UByte* start = data_.data();
	UByte* end = data_.data() + data_.size();
	return ObjectType(start, end);
}

QVPN::Core::DataStructures::DataPacketLittleEndian::ViewType QVPN::Core::DataStructures::DataPacketLittleEndian::to_view()
{
	UByte* start = data_.data();
	UByte* end = data_.data() + data_.size();
	return ViewType(start, end);
...
QVPN::Core::DataStructures::DataPacketLittleEndian::ObjectType QVPN::Core::DataStructures::DataPacketLittleEndian::to_data_object()
{
	UByte* start = data_.data();
	UByte* end = data_.data() + data_.size();
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::DataPacketLittleEndian::ViewType QVPN::Core::DataStructures::DataPacketLittleEndian::to_data_view()
{
	UByte* start = data_.data();
	UByte* end = data_.data() + data_.size();
	return ViewType(start, end);
...
QVPN::Core::DataStructures::Ipv4PacketView::ObjectType QVPN::Core::DataStructures::Ipv4PacketView::to_object()
{
	UByte* start = header_;
	UByte* end = additional_header_ + add_header_size_;
	return ObjectType(start, end);
}

QVPN::Core::DataStructures::Ipv4PacketView::ViewType QVPN::Core::DataStructures::Ipv4PacketView::to_view()
{
	UByte* start = header_;
	UByte* end = additional_header_ + add_header_size_;
	return ViewType(start, end);
...
QVPN::Core::DataStructures::Ipv4PacketView::ObjectType QVPN::Core::DataStructures::Ipv4PacketView::to_net_object()
{
	UByte* start = header_;
	UByte* end = additional_header_ + add_header_size_;
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::Ipv4PacketView::ViewType QVPN::Core::DataStructures::Ipv4PacketView::to_net_view()
{
	UByte* start = header_;
	UByte* end = additional_header_ + add_header_size_;
	return ViewType(start, end);
...
void QVPN::Core::DataStructures::Ipv4PacketView::set_ip_total_length(UShort length)
{
	header_[2] = length >> 8 & 0xFF;
	header_[3] = length & 0xFF;
}
...
std::pair<QVPN::Core::DataStructures::Ipv4PacketView::ConstDataIterator_t, QVPN::Core::DataStructures::Ipv4PacketView::ConstDataIterator_t> QVPN::Core::DataStructures::Ipv4PacketView::to_net_bytes() const
{
	return std::make_pair<>(header_, additional_header_ + add_header_size_);
}

std::pair<QVPN::Core::DataStructures::Ipv4PacketView::DataIterator_t, QVPN::Core::DataStructures::Ipv4PacketView::DataIterator_t> QVPN::Core::DataStructures::Ipv4PacketView::to_net_bytes()
{
	return std::make_pair<>(header_, additional_header_ + add_header_size_);
}
...
QVPN::Core::DataStructures::TcpPacketView::ObjectType QVPN::Core::DataStructures::TcpPacketView::to_object()
{
	UByte* start = tcp_header_;
	UByte* end = options_ + tcp_options_size;
	return ObjectType(start, end);
}

QVPN::Core::DataStructures::TcpPacketView::ViewType QVPN::Core::DataStructures::TcpPacketView::to_view()
{
	UByte* start = tcp_header_;
	UByte* end = options_ + tcp_options_size;
	return ViewType(start, end);
...
QVPN::Core::DataStructures::TcpPacketView::ObjectType QVPN::Core::DataStructures::TcpPacketView::to_transport_object()
{
	UByte* start = tcp_header_;
	UByte* end = options_ + tcp_options_size;
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::TcpPacketView::ViewType QVPN::Core::DataStructures::TcpPacketView::to_transport_view()
{
	UByte* start = tcp_header_;
	UByte* end = options_ + tcp_options_size;
	return ViewType(start, end);
...
bool QVPN::Core::DataStructures::TcpPacketView::is_reset_connection_packet() const
{
	auto flags = get_tcp_flags();
	if (flags.get_fin() == 1 || flags.get_rst() == 1)
		return true;
...
std::pair<QVPN::Core::DataStructures::TcpPacketView::ConstDataIterator_t, QVPN::Core::DataStructures::TcpPacketView::ConstDataIterator_t> QVPN::Core::DataStructures::TcpPacketView::to_transport_bytes() const
{
	return std::make_pair<>(tcp_header_, options_ + tcp_options_size);
}

std::pair<QVPN::Core::DataStructures::TcpPacketView::DataIterator_t, QVPN::Core::DataStructures::TcpPacketView::DataIterator_t> QVPN::Core::DataStructures::TcpPacketView::to_transport_bytes()
{
	return std::make_pair<>(tcp_header_, options_ + tcp_options_size);
}
...
void QVPN::Core::DataStructures::TcpPacketView::set_tcp_length(UByte word_length)
{
	tcp_header_[12] = tcp_header_[12] | (word_length << 4);
}
...
void QVPN::Core::DataStructures::TcpPacketView::set_src_port(UShort port)
{
	tcp_header_[0] = static_cast<UByte>(port >> 8 & 0xFF);
	tcp_header_[1] = static_cast<UByte>(port & 0xFF);
}

void QVPN::Core::DataStructures::TcpPacketView::set_transport_length(UShort bytes_length)
{
...
QVPN::Core::DataStructures::UdpPacketView::ObjectType QVPN::Core::DataStructures::UdpPacketView::to_object()
{
	UByte* start = header_;
	UByte* end = header_ + udp_header_size;
	return ObjectType(start, end);
}

QVPN::Core::DataStructures::UdpPacketView::ViewType QVPN::Core::DataStructures::UdpPacketView::to_view()
{
	UByte* start = header_;
	UByte* end = header_ + udp_header_size;
	return ViewType(start, end);
...
QVPN::Core::DataStructures::UdpPacketView::ObjectType QVPN::Core::DataStructures::UdpPacketView::to_transport_object()
{
	UByte* start = header_;
	UByte* end = header_ + udp_header_size;
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::UdpPacketView::ViewType QVPN::Core::DataStructures::UdpPacketView::to_transport_view()
{
	UByte* start = header_;
	UByte* end = header_ + udp_header_size;
	return ViewType(start, end);
...
bool QVPN::Core::DataStructures::UdpPacketView::is_reset_connection_packet() const
{
	return false;
}

std::pair<QVPN::Core::DataStructures::UdpPacketView::ConstDataIterator_t, QVPN::Core::DataStructures::UdpPacketView::ConstDataIterator_t> QVPN::Core::DataStructures::UdpPacketView::to_transport_bytes() const
{
	return std::make_pair<>(header_, header_ + udp_header_size);
}

std::pair<QVPN::Core::DataStructures::UdpPacketView::DataIterator_t, QVPN::Core::DataStructures::UdpPacketView::DataIterator_t> QVPN::Core::DataStructures::UdpPacketView::to_transport_bytes()
{
	return std::make_pair<>(header_, header_ + udp_header_size);
}
...
void QVPN::Core::DataStructures::UdpPacketView::set_src_port(UShort port)
{
	header_[0] = static_cast<UByte>(port >> 8 & 0xFF);
	header_[1] = static_cast<UByte>(port & 0xFF);
}
...
QVPN::Core::DataStructures::DataPacketView::DataPacketView()
...
std::pair<QVPN::Core::DataStructures::DataPacketView::ConstDataIterator_t, QVPN::Core::DataStructures::DataPacketView::ConstDataIterator_t> QVPN::Core::DataStructures::DataPacketView::get_payload() const
{
	return std::make_pair<>(data_, data_ + data_size_);
}

std::pair<QVPN::Core::DataStructures::DataPacketView::DataIterator_t, QVPN::Core::DataStructures::DataPacketView::DataIterator_t> QVPN::Core::DataStructures::DataPacketView::get_payload()
{
...
std::pair<QVPN::Core::DataStructures::DataPacketView::DataIterator_t, QVPN::Core::DataStructures::DataPacketView::DataIterator_t> QVPN::Core::DataStructures::DataPacketView::to_data_bytes()
{
	auto data_end = data_ + data_size_;
	return std::pair<DataIterator_t, DataIterator_t>(data_, data_end);
}
...
QVPN::Core::DataStructures::DataPacketView::ObjectType QVPN::Core::DataStructures::DataPacketView::to_object()
{
	UByte* start = data_;
	UByte* end = data_ + data_size_;
	return ObjectType(start, end);
}

QVPN::Core::DataStructures::DataPacketView::ViewType QVPN::Core::DataStructures::DataPacketView::to_view()
{
	UByte* start = data_;
	UByte* end = data_ + data_size_;
	return ViewType(start, end);
...
QVPN::Core::DataStructures::DataPacketView::ObjectType QVPN::Core::DataStructures::DataPacketView::to_data_object()
{
	UByte* start = data_;
	UByte* end = data_ + data_size_;
	return ObjectType(start, end);
...
QVPN::Core::DataStructures::DataPacketView::ViewType QVPN::Core::DataStructures::DataPacketView::to_data_view()
{
	UByte* start = data_;
	UByte* end = data_ + data_size_;
	return ViewType(start, end);
...
std::string QVPN::Core::DataStructures::Http1PacketRequestLittleEndian::get_http_request_body() const
{
	...
	auto size = std::distance(e, data_.data() + data_.size());
...
{
	auto pos = HttpTools::find_http_header_end(data_.data(), data_.data() + data_.size());
	return std::make_pair<ConstDataIterator_t, ConstDataIterator_t>(data_.data(), data_.data() + pos);
}
...
{
	auto pos = HttpTools::find_http_header_end(data_.data(), data_.data());
	return std::make_pair<ConstDataIterator_t, ConstDataIterator_t>(data_.data() + pos, data_.data());
}
...
{
	return std::make_pair<>(data_.data(), data_.data());
}
...
{
	auto pos = HttpTools::find_http_header_end(data_.data(), data_.data() + data_.size());
	return std::make_pair<>(data_.data(), data_.data() + pos);
}
...
{
	auto pos = HttpTools::find_http_header_end(data_.data(), data_.data() + data_.size());
	return std::make_pair<>(data_.data() + pos, data_.data() + data_.size());
}
...
QVPN::Core::DataStructures::TLSRandomLittleEndian QVPN::Core::DataStructures::TLSRandomLittleEndian::generate_object()
{
	...
	return TLSRandomLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(random_bytes_.data() + 4, random_bytes_.data() + random_bytes_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(random_bytes_.data(), random_bytes_.data() + random_bytes_.size());
}
...
QVPN::Core::DataStructures::TLSSessionIDLittleEndian QVPN::Core::DataStructures::TLSSessionIDLittleEndian::generate_object(UByte length)
{
	...
	return TLSSessionIDLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<DataIterator_t, DataIterator_t>(id_.data() + 1, id_.data() + id_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(id_.data() + 1, id_.data() + id_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(id_.data(), id_.data() + id_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(data_.data() + 4, data_.data() + data_.size());
}
...
QVPN::Core::DataStructures::TLSSupportedVersionsClientHelloExtensionLittleEndian QVPN::Core::DataStructures::TLSSupportedVersionsClientHelloExtensionLittleEndian::generate_object(std::pair<SupVerIter, SupVerIter> versions)
{
	...
	return TLSSupportedVersionsClientHelloExtensionLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(versions_.data() + 1, versions_.data() + versions_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(versions_.data(), versions_.data() + versions_.size());
}
...
QVPN::Core::DataStructures::TLSKeyShareEntryLittleEndian QVPN::Core::DataStructures::TLSKeyShareEntryLittleEndian::generate_object(UShort length, TLSKeyTypes key_type)
{
	...
	return TLSKeyShareEntryLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(key_exchange_.data() + 4, key_exchange_.data() + key_exchange_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(key_exchange_.data(), key_exchange_.data() + key_exchange_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(client_shares_.data() + 2, client_shares_.data() + client_shares_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(client_shares_.data(), client_shares_.data() + client_shares_.size());
}
...
{
	auto obj_bytes = generate_object_bytes(length);
	return TLSCipherSuitLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(ciphers_.data() + 2, ciphers_.data() + ciphers_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(ciphers_.data(), ciphers_.data() + ciphers_.size());
}
...
{
	auto obj_bytes = generate_object_bytes(length);
	return TLSCompressionLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(compressions_.data() + 1, compressions_.data() + compressions_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(compressions_.data(), compressions_.data() + compressions_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(extensions_.data() + 2, extensions_.data() + extensions_.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(extensions_.data(), extensions_.data() + extensions_.size());
}
...
QVPN::Core::DataStructures::TLSServerNameIndicationExtensionLittleEndian QVPN::Core::DataStructures::TLSServerNameIndicationExtensionLittleEndian::generate_object(std::pair<SNIIter, SNIIter> hosts)
{
	...
	return TLSServerNameIndicationExtensionLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(data_.data() + 2, data_.data() + data_.size());
}
...
{
	return std::pair<DataIterator_t, DataIterator_t>(data_.data() + 4, data_.data() + data_.size());
}
...
{
	auto obj_bytes = generate_object_bytes(length);
	return TLSServerNameIndicationEntryLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(data_.data() + 3, data_.data() + data_.size());
}
...
QVPN::Core::DataStructures::TLSSupportedVersionsEntryLittleEndian QVPN::Core::DataStructures::TLSSupportedVersionsEntryLittleEndian::generate_object(UShort length, TLSProtocolVersion version)
{
	...
	return TLSSupportedVersionsEntryLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(data_.data() + sizeof(TLSRecordType) + sizeof(TLSProtocolVersion) + sizeof(UShort), data_.data() + data_.size());
}
...
{
	return static_cast<UInt>(data_[2] << 24 | data_[3] << 16 | data_[4] << 8 | data_[5]);
}
...
UShort QVPN::Core::DataStructures::QTunnelTCPViewScheme::get_scheme_data_length() const
{
	return static_cast<UShort>(data_[0] << 8 & 0xFF | data_[1]);
}

QVPN::Core::TransportProtocol QVPN::Core::DataStructures::QTunnelTCPViewScheme::get_scheme_protocol() const
{
...
std::vector<UByte> QVPN::Core::DataStructures::QTunnelTCPViewScheme::generate_object_bytes(TcpPacketView tcp_packet)
{
	...
	size += sizeof(seq) + sizeof(ack) + sizeof(flags);
	...
	size += sizeof(offset) + sizeof(window) + sizeof(urgent);
	...
	size += static_cast<UShort>(std::distance(b, e));

	res.insert(res.begin(), size >> 8 & 0xFF);
	res.insert(res.begin() + 1, size & 0xFF);
...
UShort QVPN::Core::DataStructures::QTunnelUDPViewScheme::get_scheme_data_length() const
{
	return static_cast<UShort>(data_[0] << 8 | data_[1]);
}

QVPN::Core::TransportProtocol QVPN::Core::DataStructures::QTunnelUDPViewScheme::get_scheme_protocol() const
{
...
QVPN::Core::DataStructures::TLSSupportedVersionsServerHelloExtensionLittleEndian QVPN::Core::DataStructures::TLSSupportedVersionsServerHelloExtensionLittleEndian::generate_object(TLSProtocolVersion version)
{
	...
	return TLSSupportedVersionsServerHelloExtensionLittleEndian(obj_bytes.data(), obj_bytes.data() + obj_bytes.size());
}
...
// IPv4 default gen strategy


QVPN::Core::NetProtocol QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_ver() const
{
	return NetProtocol::IPv4;
}

UByte QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_header_length() const
{
	return 5;
}

UByte QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_dscp() const
{
	return 0;
}

UByte QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_ecn() const
{
	return 0;
}

UByte QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_qos() const
{
	auto dscp = get_dscp();
	auto ecn = get_ecn();
	return dscp << 6 | ecn & 0x03;
}

UShort QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_id() const
{
	return last_id_;
}

std::vector<UByte> QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_additional_headers() const
{
	return std::vector<UByte>{};
}

UShort QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_next_id() const
{
	return ++last_id_;
}

UByte QVPN::Core::DataStructures::IPv4DefaultGenStrategy::get_ttl() const
{
	return 64;
}
...
std::pair<QVPN::Core::DataStructures::DummyNetPacket::ConstDataIterator_t, QVPN::Core::DataStructures::DummyNetPacket::ConstDataIterator_t> QVPN::Core::DataStructures::DummyNetPacket::to_net_bytes() const
{
...
std::pair<QVPN::Core::DataStructures::DummyNetPacket::DataIterator_t, QVPN::Core::DataStructures::DummyNetPacket::DataIterator_t> QVPN::Core::DataStructures::DummyNetPacket::to_net_bytes()
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(static_cast<ConstDataIterator_t>(nullptr), static_cast<ConstDataIterator_t>(nullptr));
}
...
void QVPN::Core::DataStructures::DummyNetPacket::set_data(UByte* begin, UByte* end)
{}
...
QVPN::Core::DataStructures::DummyNetPacket::ObjectType QVPN::Core::DataStructures::DummyNetPacket::to_object()
{
	return ObjectType();
}

QVPN::Core::DataStructures::DummyNetPacket::ViewType QVPN::Core::DataStructures::DummyNetPacket::to_view()
{
	return ViewType();
}

QVPN::Core::DataStructures::DummyNetPacket::ObjectType QVPN::Core::DataStructures::DummyNetPacket::to_net_object()
{
	return ObjectType();
}

QVPN::Core::DataStructures::DummyNetPacket::ViewType QVPN::Core::DataStructures::DummyNetPacket::to_net_view()
{
	return ViewType();
}
...
std::pair<QVPN::Core::DataStructures::DummyTransportPacket::ConstDataIterator_t, QVPN::Core::DataStructures::DummyTransportPacket::ConstDataIterator_t> QVPN::Core::DataStructures::DummyTransportPacket::to_transport_bytes() const
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(static_cast<ConstDataIterator_t>(nullptr), static_cast<ConstDataIterator_t>(nullptr));
}

std::pair<QVPN::Core::DataStructures::DummyTransportPacket::DataIterator_t, QVPN::Core::DataStructures::DummyTransportPacket::DataIterator_t> QVPN::Core::DataStructures::DummyTransportPacket::to_transport_bytes()
{
	return std::pair<DataIterator_t, DataIterator_t>(static_cast<DataIterator_t>(nullptr), static_cast<DataIterator_t>(nullptr));
}
...
void QVPN::Core::DataStructures::DummyTransportPacket::set_src_port(UShort port)
{
...
bool QVPN::Core::DataStructures::DummyTransportPacket::is_reset_connection_packet() const
{
	return false;
}
...
QVPN::Core::DataStructures::DummyTransportPacket::ObjectType QVPN::Core::DataStructures::DummyTransportPacket::to_transport_object()
{
	return ObjectType();
}

QVPN::Core::DataStructures::DummyTransportPacket::ViewType QVPN::Core::DataStructures::DummyTransportPacket::to_transport_view()
{
	return ViewType();
}

void QVPN::Core::DataStructures::DummyTransportPacket::set_data(UByte* begin, UByte* end)
{}
...
QVPN::Core::DataStructures::DummyTransportPacket::ObjectType QVPN::Core::DataStructures::DummyTransportPacket::to_object()
{
	return ObjectType();
}

QVPN::Core::DataStructures::DummyTransportPacket::ViewType QVPN::Core::DataStructures::DummyTransportPacket::to_view()
{
	return ViewType();
}

std::pair<QVPN::Core::DataStructures::DummyDataPacket::DataIterator_t, QVPN::Core::DataStructures::DummyDataPacket::DataIterator_t> QVPN::Core::DataStructures::DummyDataPacket::get_payload()
{
	return std::pair<DataIterator_t, DataIterator_t>(static_cast<DataIterator_t>(nullptr), static_cast<DataIterator_t>(nullptr));
}

std::pair<QVPN::Core::DataStructures::DummyDataPacket::ConstDataIterator_t, QVPN::Core::DataStructures::DummyDataPacket::ConstDataIterator_t> QVPN::Core::DataStructures::DummyDataPacket::get_payload() const
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(static_cast<ConstDataIterator_t>(nullptr), static_cast<ConstDataIterator_t>(nullptr));
}

void QVPN::Core::DataStructures::DummyDataPacket::set_payload(UByte* begin, UByte* end)
{}
...
std::pair<QVPN::Core::DataStructures::DummyDataPacket::ConstDataIterator_t, QVPN::Core::DataStructures::DummyDataPacket::ConstDataIterator_t> QVPN::Core::DataStructures::DummyDataPacket::to_data_bytes() const
{
	return std::pair<ConstDataIterator_t, ConstDataIterator_t>(static_cast<ConstDataIterator_t>(nullptr), static_cast<ConstDataIterator_t>(nullptr));
}

std::pair<QVPN::Core::DataStructures::DummyDataPacket::DataIterator_t, QVPN::Core::DataStructures::DummyDataPacket::DataIterator_t> QVPN::Core::DataStructures::DummyDataPacket::to_data_bytes()
{
	return std::pair<DataIterator_t, DataIterator_t>(static_cast<DataIterator_t>(nullptr), static_cast<DataIterator_t>(nullptr));
}
...
QVPN::Core::DataStructures::DummyDataPacket::ViewType QVPN::Core::DataStructures::DummyDataPacket::to_view()
{
	return ViewType();
}

QVPN::Core::DataStructures::DummyDataPacket::ObjectType QVPN::Core::DataStructures::DummyDataPacket::to_data_object()
{
	return ObjectType();
}
